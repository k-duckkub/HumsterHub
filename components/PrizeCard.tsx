...
export function PrizeCard({ onLater, reduced }: Props) {
  return (
    ...
    >
      ...
      {/* ═══════ รางวัลมาใส่ตรงนี้ ═══════
          The activity card that used to sit here is gone until the real reward
          list arrives. Whatever replaces it goes above the check-in block, not
          below: the check-in is the action, and an action reads last. */}
